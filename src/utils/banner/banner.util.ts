import {
  ...
  MAIN_BANNER_HEIGHT_PLUS_BOTTOM, MAIN_BANNER_POSITION
...
export const getPosition = () => {
  ...
  return height - HEADER_BANNER_HEIGHT_PLUS_TOP <= MAIN_BANNER_HEIGHT_PLUS_BOTTOM ? MAIN_BANNER_POSITION.TOP : MAIN_BANNER_POSITION.BOTTOM;
}
